...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // FormSubmit API එක හරහා කෙලින්ම Email යැවීම
    try {
      const response = await fetch("https://formsubmit.co/ajax/info@micronsoftware.lk", {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...
          Email: email,
          Message: message,
          _subject: "New Contact Form Submission - Micron Software", // එන ඊමේල් එකේ මාතෘකාව
        }),
      });

      if (response.ok) {
        showAlert("✅ Message sent successfully!");
        // යැව්වට පස්සේ form එක හිස් කිරීම
      ...
      showAlert("⚠️ Error sending message. Check your connection.");
    }
  };
    ...
    <>
      ...
      <section className="relative w-full min-h-screen py-32 px-6 bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 mt-20 max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
          ...
          >
            <h3 className="text-xl font-bold text-cyan-300 mb-6">Send Message</h3>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3 bg-cyan-500 text-black font-black rounded-xl hover:scale-105 transition shadow-[0_0_30px_#06B6D4] cursor-pointer"
              >
                Send Message
              </button>
            </div>
          ...
          >
            <h3 className="text-xl font-bold text-cyan-300 mb-6">Contact Info</h3>
            ...
            <div className="space-y-6 text-slate-300">
              ...
              <div className="flex gap-4 mt-8 flex-wrap">
                ...
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/share/18mNdXuBDs/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* X (Twitter) */}
                <a
                  href="https://x.com/micronsoftsl?fbclid=IwVERDUASDy5pleHRuA2FlbQIxMABzcnRjBmFwcF9pZAwzNTA2ODU1MzE3MjgAAR7ySwiITA5IjiCyStFTSb1vZ5RL-VrtC9VCjUbPIzTzz-iooNkOPWdzTfIsgw_aem_x6mBY-wUz258VAwSSKEELQ"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/micronsoftsl?igsh=aXBjN2VqeWl2cmhn"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@micronsoft?_r=1&_t=ZS-96i9xSqdBbh"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <div className="mt-8 pt-6 border-t border-white/10">
                <div className="rounded-xl overflow-hidden border border-white/10 shadow-[0_0_20px_rgba(6,182,212,0.1)]">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3968.330840116463!2d80.5415684!3d5.9490678!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae13f9061176c5b%3A0xbc48d68849b37fcf!2sMicronsoft%20Solutions%20(Pvt)%20Ltd!5e0!3m2!1sen!2slk!4v1781051042414!5m2!1sen!2slk"
        ...
        <div className="relative z-10 text-center mt-24">
          ...
          <button
            onClick={focusForm}
            className="mt-6 px-8 py-3 bg-cyan-500 text-black font-bold rounded-xl hover:scale-105 transition shadow-[0_0_30px_#06B6D4] cursor-pointer"
          >
            Get Started
          </button>
        </div>
      ...
      <PageFooter />
      {alertMsg && (
        <div className="fixed top-6 right-6 bg-cyan-500 text-black font-bold px-6 py-3 rounded-xl shadow-lg z-[999] animate-pulse">
          {alertMsg}
        </div>
      )}
    </>
